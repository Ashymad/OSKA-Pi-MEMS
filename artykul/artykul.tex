...
Pi do tworzenia wszelkiego rodzaju platform pomiarowych. Takie aplikacje
...
za jego analizę. W wielu przypadkach duża dokładność pomiaru wymusza zastosowanie profesjonalnych, wyspecjalizowanych przetworników, ale niekiedy zdarza się, że sygnał pomiarowy nie wymaga bardzo dużej rozdzielczości lub częstotliwości próbkowania. 

\section{Opis realizacji projektu}

Stację badawczą skonstruowano z mikrokomputera Raspberry Pi 3 model B oraz
trzyosiowego akcelerometru MMA8451 firmy Adafruit. Wykorzystany model Raspberry
